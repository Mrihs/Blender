...
![Animation 1: Bewegung von Objekten.](images/Chapter8/Move.gif){width=100%}
</div>
...
<div style= "float:right;position: relative; padding: 1%; width: 30%; font-size:60%;">
![Animation 2: Rotation eines Würfels entlang der X-Achse.](images/Chapter8/rotate.gif){width=100%}
</div>
